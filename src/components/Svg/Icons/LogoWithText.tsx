...
const Logo: React.FC<LogoProps> = ({ isDark, ...props }) => {
  return (
    ...
    >
      ...
      <path
        d="M54.883 32.437c-5.421 0-9.98-3.865-9.98-9.815 0-5.7 4.114-10.259 10.87-10.259 3.78 0 5.7 1.946 5.7 4.087v1.919h-.14c-1-.918-2.752-1.696-5.7-1.696-2.863 0-5.448 1.89-5.448 5.504 0 4.143 2.28 5.958 5.163 5.958 1.529 0 1.64-.5 1.64-1.191v-2.141a10.636 10.636 0 00-.361-2.641h2.697c1.695 0 2.585 1.112 2.585 2.557v2.558c-.02 3.158-1.994 5.16-7.026 5.16z"
        id="prefix__path3286"
        fill="url(#prefix__linearGradient3594)"
        strokeWidth={0.397}
      />
      <path
        d="M70.09 32.214c-2.807 0-5.226-1.668-5.226-5.282V11.418h1.883c2.307 0 3.42 1.057 3.42 3.642v11.093c0 1.363.75 1.78 2.224 1.78h1.147v1.834c0 1.863-1.779 2.447-3.447 2.447z"
        id="prefix__path3288"
        fill="url(#prefix__linearGradient3596)"
        strokeWidth={0.397}
      />
      <path
        d="M77.987 15.839a2.617 2.617 0 112.752-2.614 2.705 2.705 0 01-2.752 2.614zm2.502 16.375c-2.808 0-5.004-1.39-5.004-5.004V17.173h1.306c3.003 0 3.972.862 3.972 3.642v5.616c0 1.363.64 1.78 2.113 1.78h.64v1.556c.003 1.835-1.387 2.447-3.027 2.447z"
        id="prefix__path3290"
        fill="url(#prefix__linearGradient3598)"
        strokeWidth={0.397}
      />
      <path
        d="M92.889 32.437a7.967 7.967 0 01-7.98-7.84c0-5.164 3.178-8.341 7.229-8.341 1.946 0 3.392.861 3.948 2.057v-6.895h1.89c2.113 0 3.253 1.112 3.253 3.698v8.869c0 5.532-2.252 8.452-8.34 8.452zm-.112-12.094c-1.417 0-2.613 1.473-2.613 3.808 0 3.003 1.39 4.226 3.309 4.226 1.64 0 2.502-1.279 2.502-3.67 0-3.42-1.307-4.364-3.198-4.364z"
        id="prefix__path3292"
        fill="url(#prefix__linearGradient3600)"
        strokeWidth={0.397}
      />
      <path
        d="M111.294 26.237h-2.28c.306 1.529 1.557 2.252 3.753 2.252 2.447 0 3.972-.398 4.838-.973h.194v1.223c0 1.946-1.588 3.698-5.957 3.698-5.283 0-8.063-3.575-8.063-7.785 0-4.643 3.142-8.424 7.868-8.424 4.004 0 7.118 2.252 7.118 6.144.011 3.058-2.3 3.865-7.471 3.865zm.361-6.061c-1.863 0-2.641 1.191-2.78 2.669h2.057c2.503 0 2.947-.397 2.947-1.057 0-.778-.695-1.612-2.224-1.612z"
        id="prefix__path3294"
