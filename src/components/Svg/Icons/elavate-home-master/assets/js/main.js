  ...
  function yose_backgrounds(){
    ...
    coll[0].addEventListener("click", function() {
      for (i = 0; i < content.length; i++) {
        if (content[i].style.display === "contents") {
          content[i].style.display = "none";
          coll[0].style.transform = "rotate(0deg)";
        } else {
          content[i].style.display = "contents";
          coll[0].style.transform = "rotate(180deg)";
          coll[0].style.transition = "all 1s";
        }
      }
    });
